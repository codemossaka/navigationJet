package ru.godsonpeya.navigationjet.database

import kotlinx.coroutines.flow.MutableStateFlow
import ru.godsonpeya.navigationjet.database.entity.SongEntity


val data = MutableStateFlow(listOf(
...
fun getSongById(id: Long): SongEntity {
    return data.value.find { it.id == id } ?: throw IllegalArgumentException("Song not found")
}